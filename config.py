...
DIMENSIONS = [15, 15] # Forma del mapa (de moment matriu)
...
PROBABILITATS_VEINS=[0.3, 0.3, 0.3] # vector de proporcions dels veins
...
DISTANCIA_MAXIMA_VEINS = 5 # distancia en la que els veins s'afecten
